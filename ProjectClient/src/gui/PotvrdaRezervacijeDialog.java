 ...
 */
public class PotvrdaRezervacijeDialog extends javax.swing.JDialog {

    Rezervacija rez;
    RezervacijeAdminDialog parent;

    public PotvrdaRezervacijeDialog(RezervacijeAdminDialog parent, boolean modal, Rezervacija rez) {
        super(parent, modal);
        initComponents();
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Sistem ne može da prikaže podatke o rezervaciji");
            try {
                dispose();
                parent.osvezi();
            } catch (Exception ex1) {
                JOptionPane.showMessageDialog(parent, "Greška prilikom osvežavanje tabele");
                Logger.getLogger(PotvrdaRezervacijeDialog.class.getName()).log(Level.SEVERE, null, ex1);
            }
        }
    }
    ...
    private void btnPotvrdiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPotvrdiActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(this, "Sistem je potvrdio rezervaciju!","Potvrdjivanje rezervacije",JOptionPane.INFORMATION_MESSAGE);
            dispose();
        } catch (IOException ex) {
            Logger.getLogger(PotvrdaRezervacijeDialog.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Sistem ne može da potvrdi rezervaciju!", "Potvrdjivanje rezervacije", JOptionPane.ERROR_MESSAGE);
            Logger.getLogger(PotvrdaRezervacijeDialog.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void fillForm() throws Exception {
        txtLet.setText(rez.getLet().toString());
        SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy");
        txtDatumPolaska.setText(format.format(rez.getLet().getDatumPolaska()));
        txtDatumRezervacije.setText(format.format(new Date()));
        txtImePrezime.setText(rez.getKorisnik().getIme() + " " + rez.getKorisnik().getPrezime());
        txtBrojPasosa.setText(rez.getKorisnik().getBrPasosa() + "");
        txtCena.setText(rez.getLet().getCenaLeta() + " RSD");
    }
}
